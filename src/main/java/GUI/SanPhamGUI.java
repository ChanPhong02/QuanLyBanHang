...
//        btnEdit,btnDelete,btnConfirm,btnBack,btnFile
        ...
        //màu nền
        Color colorAdd = new Color(121, 218, 121);
        btnAdd.setBackground(colorAdd);
        Color colorEdit = new Color(121, 218, 121);
        btnEdit.setBackground(colorEdit);
        Color colorDelete = new Color(121, 218, 121);
        btnDelete.setBackground(colorDelete);
        Color colorConfirm = new Color(121, 218, 121);
        btnConfirm.setBackground(colorConfirm);
        Color colorBack = new Color(121, 218, 121);
        btnBack.setBackground(colorBack);
        Color colorFile = new Color(121, 218, 121);
        btnFile.setBackground(colorFile);

        //viền
        btnAdd.setBorder(createLineBorder(new Color(64, 134, 64), 5, true));
        btnEdit.setBorder(createLineBorder(new Color(64, 134, 64), 5, true));
        btnDelete.setBorder(createLineBorder(new Color(64, 134, 64), 5, true));
        btnConfirm.setBorder(createLineBorder(new Color(64, 134, 64), 5, true));
        btnBack.setBorder(createLineBorder(new Color(64, 134, 64), 5, true));
        btnFile.setBorder(createLineBorder(new Color(64, 134, 64), 5, true));
...
//        header.add("Mă NSX");
        ...
        tbl.getTableHeader().setBackground(new Color(64, 134, 64)); //232, 57, 99
        tbl.getTableHeader().setForeground(Color.WHITE);
        tbl.setSelectionBackground(new Color(52, 219, 152));
