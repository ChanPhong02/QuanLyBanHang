...
public class header extends JPanel{
    ...
    public void init()
    {
        ...
        JLabel name = new JLabel("QUẢN LÝ",JLabel.CENTER);
        name.setFont(font);
...
//        navItem exit = new navItem("", new Rectangle(width-40, -8, 40, 50), "exit_25px.png", "exit_25px.png", new Color(80,255,80));
//        navItem minimize = new navItem("", new Rectangle(width-80, -8, 40, 50), "minimize_25px.png", "minimize_25px.png", new Color(80,255,80));
//        
