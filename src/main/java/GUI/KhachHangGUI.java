...
//
    ...
    public void init() {
        ...
        //màu nền
        Color color = new Color(121, 255, 121);
...
//        JLabel btnBack = new JLabel(new ImageIcon("./src/image/btnBack.png"));
        ...
        tbl.getTableHeader().setBackground(new Color(64, 134, 64));
        tbl.getTableHeader().setForeground(Color.WHITE);
        tbl.setSelectionBackground(new Color(100, 200, 100));
        ...
        txtSearch.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                ...
                searchBox.setBorder(createLineBorder(new Color(52,200, 52))); // Đổi màu viền
            }
